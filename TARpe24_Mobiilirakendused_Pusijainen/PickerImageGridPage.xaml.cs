...
public partial class PickerImageGridPage : ContentPage
{
	...
	Random rnd = new Random(); // piltide juhuslikkuks valimiseks
	...
	{
		if (picker.SelectedIndex == -1) return; // kui midagi pole valitud, tagasta
		if (picker.SelectedIndex == 0) img.Source = "cow_emoji.png";
		else if (picker.SelectedIndex == 1) img.Source = "face.png";
		else if (picker.SelectedIndex == 2) img.Source = "lehmnostardamus.png";
